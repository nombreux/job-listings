...
const Header = () => {
      return (
            <div className={css({
                  ...
                  <svg
                        // className={css({ marginLeft: '200px' })}
                        xmlns="http://www.w3.org/2000/svg" width="100vw" height="156">
...
export const PhotosnapIcon = () => {
      return (
            <svg xmlns="http://www.w3.org/2000/svg" href="http://www.w3.org/1999/xlink" width="88" height="88">
                  <defs>
                  ...
                  <g fill="none" fill-rule="evenodd">
                        ...
                        <path fill="url(#c)" d="M0 6l4-6 4 6z" transform="translate(12 41)" />
                  </g>
            </svg>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" href="http://www.w3.org/1999/xlink" width="88" height="88">
                  ...
                  <g fill="none" fill-rule="evenodd">
                        ...
                        <g fill="#FFF" transform="translate(13 39)">
                              ...
                              <path
                                    d="M1.17 4.286c.646 0 1.17.533 1.17 1.19a1.18 1.18 0 01-1.17 1.19A1.18 1.18 0 010 5.477c0-.657.524-1.19 1.17-1.19zM1.17 0c.646 0 1.17.533 1.17 1.19a1.18 1.18 0 01-1.17 1.191A1.18 1.18 0 010 1.191C0 .532.524 0 1.17 0zm4.212 0c.646 0 1.17.533 1.17 1.19a1.18 1.18 0 01-1.17 1.191 1.18 1.18 0 01-1.17-1.19C4.212.532 4.736 0 5.382 0z" />
                              <ellipse cx="5.382" cy="5.524" opacity=".5" rx="1.17" ry="1.19" />
                        </g>
                  </g>
            </svg>
      )
...
export const Insure = () => {
      return (
            <svg xmlns="http://www.w3.org/2000/svg"  width="88" height="88">
                  ...
                  <g fill="none" fill-rule="evenodd">
                        <use fill="#403646" href="#a" />
                        <use fill="#000" filter="url(#b)" href="#a" />
                        <path fill="#F3D3CA" fill-rule="nonzero"
...
export const TheAirFilterCompany = () => {
      return (
            <svg xmlns="http://www.w3.org/2000/svg"  width="88" height="88">
                  <defs>
                        <filter id="b" width="139.8%" height="139.8%" x="-19.9%" y="-19.9%" filterUnits="objectBoundingBox">
      ...
      return (
            <svg xmlns="http://www.w3.org/2000/svg"  width="88" height="88">
                  ...
                  <g fill="none" fill-rule="evenodd">
                        ...
                        <path fill="url(#c)" d="M7.421 7.953L3.71 0 0 7.953z" transform="translate(10 40)" />
                        <path fill="url(#d)" d="M10.913 7.953L7.202 0l-3.71 7.953z" transform="translate(10 40)" />
                  </g>
            </svg>
